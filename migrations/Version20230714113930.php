 ...
 */
final class Version20230714113930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reglement DROP echeance_at');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reglement ADD echeance_at VARCHAR(255) NOT NULL');
