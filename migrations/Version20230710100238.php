 ...
 */
final class Version20230710100238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD nom VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD prenoms VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP prenoms');
    }
}
